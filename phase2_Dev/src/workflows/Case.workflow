...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <description>Email Triage Responsible Regarding Rejection</description>
        <protected>false</protected>
        <recipients>
    ...
    <alerts>
        <fullName>Email_to_case_reporter_that_the_complaint_is_closed</fullName>
        <description>Email to case reporter that the complaint is closed</description>
        <protected>false</protected>
        <recipients>
            <field>ContactEmail</field>
            <type>email</type>
        ...
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_External_CommunicatioTemplate_Folder/X111_Notification_to_reporter_a_complaint_is_complete_after_investigation</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>New_Case_in_Triage_Notification</fullName>
        <description>New Case in Triage Notification</description>
        <protected>false</protected>
        <recipients>
            <field>Triage_Responsible__c</field>
            <type>userLookup</type>
        ...
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_Int_Communication_Template_Folder/X18_Case_Escalated_New_Case_sent_to_Triage_for_Original_Assignee</template>
    </alerts>
    <alerts>
        <fullName>Notify_Case_Owner_to_review_a_New_Complaint_submitted_from_Portal</fullName>
        <description>Notify Case Owner to review a New Complaint submitted from Portal</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_Int_Communication_Template_Folder/X108_New_Complaint_from_Portal_to_review</template>
    </alerts>
    <alerts>
        <fullName>Send_Email_to_Account</fullName>
        <description>Send Email to Account</description>
        <protected>false</protected>
        <recipients>
            <type>accountOwner</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>EEC_Int_Communication_Template_Folder/X133_New_Foster_Home_51A_or_Incident_Submitted</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>Send_Email_to_New_Case_Owner_about_Incident</fullName>
        <description>Send Email to New Case Owner about Incident</description>
        <protected>false</protected>
        <recipients>
            <type>accountOwner</type>
        </recipients>
    ...
    <alerts>
        <fullName>Send_Email_to_New_Case_Owner_about_Injury</fullName>
        <description>Send Email to New Case Owner and supervisor about Injury</description>
        <protected>false</protected>
        <recipients>
            <type>accountOwner</type>
        </recipients>
        ...
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_Int_Communication_Template_Folder/X124_New_Injury_From_Portal_To_Review</template>
    </alerts>
    <alerts>
    ...
    <fieldUpdates>
        <fullName>Date_first_level_Approved</fullName>
        <field>Date_case_approved_First_approver__c</field>
        <formula>Today()</formula>
        <name>Date first level Approved</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Date_second_level_Approved</fullName>
        <field>Date_case_approved_Second_approver__c</field>
        <formula>Today()</formula>
        <name>Date second level Approved</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Of_Office_Email_Template_To</fullName>
        <description>Out Of Office Email Template To Send with the API name of the template #133</description>
        <field>Out_Of_Office_Email_Template_To_Send__c</field>
        <formula>&quot;X133_New_Foster_Home_51A_or_Incident_Submitted&quot;</formula>
        <name>Of Office Email Template To</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    ...
    <fieldUpdates>
        <fullName>Out_Of_Office_Email_Template_To</fullName>
        <field>Out_Of_Office_Email_Template_To_Send__c</field>
        <formula>&quot;X130_Investigation_conclusion_submitted_for_a_Foster_Home_51A_or_Incident_from	&quot;</formula>
        <name>Out Of Office Email Template To</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Out_Of_Office_Email_Template_To_Send</fullName>
        <field>Out_Of_Office_Email_Template_To_Send__c</field>
        <formula>&quot;132 - Reminder Sent to Provider for Missing Investigation Conclusion for Foster&quot;</formula>
        <name>Out Of Office Email Template To Send</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Out_Of_Office_Initial_Recipient</fullName>
        <description>Out Of Office Initial Recipient ID with Case.Provider.Licensor</description>
        <field>Out_Of_Office_Initial_Recipient_ID__c</field>
        <formula>Account.OwnerId</formula>
        <name>Out Of Office Initial Recipient</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Out_Of_Office_Initial_RecipientID</fullName>
        <field>Out_Of_Office_Initial_Recipient_ID__c</field>
        <formula>Account.OwnerId</formula>
        <name>Out Of Office Initial RecipientID</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Out_of_Office_1st_Approver</fullName>
        <description>Set the ID of the 1st approver user (used for out of office)</description>
        <field>Out_Of_Office_Initial_Recipient_ID__c</field>
        <formula>X1st_Escalation_Case_Approver__c</formula>
        <name>Out of Office - 1st Approver</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Out_of_Office_2nd_Approver</fullName>
        <description>Set the ID of the 2nd approver user (used for out of office)</description>
        <field>Out_Of_Office_Initial_Recipient_ID__c</field>
        <formula>X2nd_Escalation_Case_Approver__c</formula>
        <name>Out of Office - 2nd Approver</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Out_of_Office_Email_19_To_Send</fullName>
        <description>Check if email #19 needs to be sent in case of out of office</description>
        <field>Out_Of_Office_Email_Template_To_Send__c</field>
        <formula>&apos;X19_Case_Escalated_Case_sent_for_review_and_approval&apos;</formula>
        <name>Out of Office Email #19 To Send</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Send_email_notification_when_status_chan</fullName>
        <description>To send email notification when status changes to &quot;Investigation Conclusions Submitted&quot;
Conditions</description>
        <field>Out_Of_Office_Email_Template_To_Send__c</field>
        <name>Send email notification when status chan</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Send_email_to_licensor</fullName>
        <field>Out_Of_Office_Initial_Recipient_ID__c</field>
        <formula>Account.Licensor_Email__c</formula>
        <name>Send email to licensor</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Set_1st_Approver_Completed</fullName>
        <field>X1st_Escalation_Case_Approver_Completed__c</field>
        <literalValue>1</literalValue>
        <name>Set 1st Approver Completed</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Set_2nd_Approver_Completed</fullName>
        <field>X2nd_Escalation_Case_Approver_Completed__c</field>
        <literalValue>1</literalValue>
        <name>Set 2nd Approver Completed</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Status_changes_to_Investigation_Conclusi</fullName>
        <description>Send email notification when status changes to &quot;Investigation Conclusions Submitted&quot;
Conditions</description>
        <field>Out_Of_Office_Email_Template_To_Send__c</field>
        <name>Status changes to Investigation Conclusi</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Unset_1st_Approver_Completed</fullName>
        <field>X1st_Escalation_Case_Approver_Completed__c</field>
        <literalValue>0</literalValue>
        <name>Unset 1st Approver Completed</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Update_date_escalated</fullName>
        <field>Date_case_escalated_first_time__c</field>
        <formula>TODAY()</formula>
        <name>Update date escalated</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Update_date_escalated_approval</fullName>
        <field>Date_case_escalated_first_time__c</field>
        <formula>TODAY()</formula>
        <name>Update date escalated</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        ...
        <field>Date_case_rejected_1st_approver__c</field>
        <formula>Today()</formula>
    ...
    <fieldUpdates>
        <fullName>Update_date_rejected_second_approver</fullName>
        <field>Date_case_Rejected_2nd_approver__c</field>
        <formula>Today()</formula>
        <name>Update date rejected: Second approver</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        ...
        <actions>
            <name>Notify_Case_Owner_to_review_a_New_Complaint_submitted_from_Portal</name>
            <type>Alert</type>
        </actions>
        <actions>
        ...
        <actions>
            <name>New_Complaint_From_Portal_to_Review</name>
            <type>Task</type>
        </actions>
        <active>true</active>
    ...
    <tasks>
        <fullName>Email_Sent_Reminder_for_missing_investigation_conclusion_sent_to_provider_131</fullName>
        <assignedTo>vsheth.eec@incapsulate.com</assignedTo>
        <assignedToType>user</assignedToType>
        <description>Email sent to provider as a reminder to submit investigation conclusions for one or more &apos;Foster Home 51A or Incident&apos; submitted from portal</description>
        <dueDateOffset>0</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        <offsetFromField>Case.Date_Closed__c</offsetFromField>
        <priority>Normal</priority>
        <protected>false</protected>
        <status>Completed</status>
        <subject>Email Sent - Reminder for missing investigation conclusion sent to provider - #131</subject>
    </tasks>
    <tasks>
    ...
    <tasks>
        <fullName>New_Complaint_From_Portal_to_Review</fullName>
        <assignedToType>owner</assignedToType>
        ...
        <subject>New Complaint From Portal to Review</subject>
    </tasks>
    <tasks>
