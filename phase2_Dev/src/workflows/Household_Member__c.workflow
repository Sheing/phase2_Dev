...
Licensing_Transactions__r.Provider__r.ShippingStreet ), Licensing_Transactions__r.Provider__r.Provider_Full_Address__c , Licensing_Transactions__r.Provider__r.Mailing_Address_Reformated__c )</formula>
    ...
    <rules>
        ...
        <formula>AND(  BRC_Required__c = TRUE,  ISPICKVAL(  Licensing_Transactions__r.Status__c , &quot;Submitted&quot;),   ISPICKVAL(  BRC_Consent_Status__c  , &quot;&quot; ),   ISBLANK(  BRC_Consent_Request_Date__c  ),    Licensing_Transactions__r.Provider__r.Electronic_Communication__c = TRUE,  ISPICKVAL(Licensing_Transactions__r.Source__c,&quot;Provider Portal&quot;), OR( Licensing_Transactions__r.Provider__r.RecordType.Name = &quot;Family Child Care&quot;, Licensing_Transactions__r.Provider__r.RecordType.Name = &quot;FCC Assistant&quot;),   Age_At_Submission__c &lt;18 )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <active>true</active>
        <description>This workflow is the implementation of https://incapsulate.atlassian.net/browse/LEAD-1050</description>
        <formula>AND( BRC_Required__c = TRUE,  OR(ISPICKVAL( Licensing_Transactions__r.Status__c , &quot;Submitted&quot;),ISPICKVAL( Licensing_Transactions__r.Status__c , &quot;Under Review&quot;)), NOT(ISPICKVAL( BRC_Consent_Status__c, &quot;Completed&quot; )), Licensing_Transactions__r.Provider__r.Electronic_Communication__c = TRUE, ISPICKVAL(Licensing_Transactions__r.Source__c,&quot;Provider Portal&quot;), OR( Licensing_Transactions__r.Provider__r.RecordType.Name = &quot;Family Child Care&quot;, Licensing_Transactions__r.Provider__r.RecordType.Name = &quot;FCC Assistant&quot;), Age_At_Submission__c &lt; 18  )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
