...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Send_Email_Notification_to_Supervisor_of_Licensor</fullName>
        <description>Send Email Notification to Supervisor of Licensor</description>
        <protected>false</protected>
        <recipients>
            <field>Assigned_To_Manager__c</field>
            <type>email</type>
        ...
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_Int_Communication_Template_Folder/X82</template>
    </alerts>
    <alerts>
...
Original_Visit__r.Zip_Code__c)</formula>
    ...
    <fieldUpdates>
        <fullName>Uncheck_Visit_Mode_Lock</fullName>
        <field>Visit_Mode_Lock__c</field>
        <literalValue>0</literalValue>
        <name>Uncheck Visit Mode Lock</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        ...
        <literalValue>Renewal - Full Review</literalValue>
    ...
    <fieldUpdates>
        <fullName>Update_Status_after_Corr_Action_Receive</fullName>
        <field>Status__c</field>
        <literalValue>Feedback received, to review</literalValue>
        <name>Update Status after Corr Action Receive</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Update_Status_after_Corr_Action_Received</fullName>
        <description>Update Status after Corr Action Received</description>
        <field>Status__c</field>
        <literalValue>Feedback received, to review</literalValue>
        <name>Update Status after Corr Action Receive</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <rules>
        <fullName>Create visit - Create task %28Unannounced visit%29</fullName>
        <actions>
            <name>Schedule_visit_UnAnnounced</name>
            <type>Task</type>
        </actions>
        <active>false</active>
        <criteriaItems>
            ...
            <operation>equals</operation>
            <value>Unannounced</value>
        </criteriaItems>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        <fullName>Create visit - Create task %28announced visit%29</fullName>
        <actions>
            <name>Schedule_visit_Announced</name>
            <type>Task</type>
        </actions>
        <active>false</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>Notify Supervisor about Tool Switch on a Visit</fullName>
        <actions>
            <name>Send_Email_Notification_to_Supervisor_of_Licensor</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <formula>AND(NOT(ISBLANK(Use_Non_Recommended_Tool_Justification__c)), ISBLANK(PRIORVALUE(Use_Non_Recommended_Tool_Justification__c)), NOT(ISBLANK(Inspector_del__c)))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>Notify Supervisor when the tool used for a visit is not the recommended one</fullName>
        <actions>
            <name>Send_Email_Notification_to_Supervisor_of_Licensor</name>
            <type>Alert</type>
        </actions>
    ...
    <rules>
        <fullName>Uncheck Visit Mode Lock</fullName>
        <actions>
            <name>Clear_username_in_Visit_Mode_Locked_By</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Uncheck_Visit_Mode_Lock</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>Update Differential Licensing Lifecycle</fullName>
        <active>false</active>
        <criteriaItems>
            <field>Inspection__c.Status__c</field>
            <operation>equals</operation>
        ...
        <criteriaItems>
            <field>Inspection__c.RecordTypeId</field>
            <operation>notEqual</operation>
            <value>Legacy System Import Visit / Non Compliance,Investigation Visits</value>
        </criteriaItems>
        <criteriaItems>
            <field>Inspection__c.Type_of_Visit__c</field>
            <operation>equals</operation>
            <value>Pre-Licensing,Renewal - Full Review,Renewal - Enhanced Monitoring,Monitoring,Progress,Enhanced Monitoring</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Update Status after Corr after Action Received</fullName>
        <actions>
            <name>Update_Status_after_Corr_Action_Received</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>ISPICKVAL( Status__c , &quot;Report Sent to Provider, Awaiting feedback&quot;) &amp;&amp; NOT(ISPICKVAL( PRIORVALUE(Status__c), &quot;Feedback received, to review&quot;)) &amp;&amp;  Number_of_non_com_items_to_review_on_por__c = 0 &amp;&amp;  Number_of_Items_with_Corrective_Actions__c != 0</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
