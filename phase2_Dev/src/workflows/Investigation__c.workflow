...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Alert_Licensor_and_Supervisor_on_escalated_investigation_closing</fullName>
        <description>Alert Licensor and Supervisor on escalated investigation closing</description>
        ...
        <recipients>
            <field>Licensor__c</field>
            <type>userLookup</type>
        </recipients>
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_Int_Communication_Template_Folder/X126_Investigation_closed_notification</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        ...
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_Int_Communication_Template_Folder/X27a_Escalated_Investigation_Review_and_Approval_Review_and_re_work_requested</template>
    </alerts>
    <alerts>
        <fullName>Escalated_Rejection_To_RD</fullName>
        <description>Escalated Investigation Process Rejected - Email Alert (to RD)</description>
        <protected>false</protected>
        <recipients>
            <field>Assigned_To__c</field>
            <type>userLookup</type>
    ...
    <alerts>
        <fullName>Inform_Investigator</fullName>
        <description>Inform Investigator and Licensor of approval</description>
        <protected>false</protected>
        <recipients>
            <field>Assigned_To__c</field>
            <type>userLookup</type>
    ...
    <alerts>
        <fullName>Notify_Licensor_and_Licensor_Supervisor_of_new_approved_escalated_investigation</fullName>
        <description>Notify Licensor and Licensor Supervisor of new approved escalated investigation</description>
        <protected>false</protected>
        <recipients>
            <field>Licensor_Manager__c</field>
            <type>userLookup</type>
        ...
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_Int_Communication_Template_Folder/X127_Investigation_approved_by_Associate_Commissioner_of_Investigations</template>
    </alerts>
    <alerts>
        <fullName>Notify_Provider_Licensor_Manager_that_an_escalated_investigation_is_sent_to</fullName>
        <description>Notify RD that an escalated investigation is sent for approval</description>
        <protected>false</protected>
        <recipients>
            <field>Leader_Director_Supervisor__c</field>
            <type>userLookup</type>
    ...
    <alerts>
        <fullName>Notify_Provider_Licensor_Supervisor_that_an_escalated_investigation_is_in_approv</fullName>
        <description>Notify Provider Licensor Supervisor that an escalated investigation is in approval</description>
        <protected>false</protected>
        <recipients>
            <field>Licensor_Manager__c</field>
            <type>userLookup</type>
    ...
    <alerts>
        <fullName>Notify_RD_and_Supervisor_to_review_the_approved_investigation</fullName>
        <description>Notify RD and Supervisor to review the approved investigation</description>
        <protected>false</protected>
        <recipients>
            <field>Leader_Director_Supervisor__c</field>
            <type>userLookup</type>
    ...
    <alerts>
        <fullName>Send_Licensor_internal_email</fullName>
        <description>Send Licensor internal email</description>
        <protected>false</protected>
        <recipients>
            <field>Assigned_To__c</field>
            <type>userLookup</type>
        ...
        <senderAddress>eecleaddonotreply@state.ma.us</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>EEC_Int_Communication_Template_Folder/X34_Alert_to_licensor_that_corrective_actions_have_been_submitted</template>
    </alerts>
    <alerts>
    ...
    <fieldUpdates>
        <fullName>Date_sent_for_approval_Non_escalated</fullName>
        <field>Date_sent_for_approval__c</field>
        <formula>Today()</formula>
        <name>Date sent for approval_Non escalated</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Date_submitted_for_approval_R_P</fullName>
        <field>Date_sent_for_approval__c</field>
        <formula>Today()</formula>
        <name>Date submitted for approval_R&amp;P</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Date_submitted_for_approval_nonR_P</fullName>
        <field>Date_sent_for_approval__c</field>
        <formula>Today()</formula>
        <name>Date submitted for approval_nonR&amp;P</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        ...
        <field>Out_Of_Office_Initial_Recipient__c</field>
        <formula>Leader_Deputy_Commisioner__c</formula>
    ...
    <fieldUpdates>
        <fullName>Out_of_Office_Email_25_To_Send</fullName>
        <description>Check if email #25 needs to be sent in case of out of office</description>
        <field>Out_Of_Office_Email_Template_To_Send_del__c</field>
        <formula>&apos;X25_Investigation_Approval_Investigation_sent_for_review_and_approval&apos;</formula>
        <name>Out of Office Email #25 To Send</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Out_of_Office_Leader_Manager</fullName>
        <field>Out_Of_Office_Initial_Recipient__c</field>
        <formula>Leader_Manager__c</formula>
        <name>Out of Office - Leader Manager</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Set_1st_Escalation_Approver_Completed</fullName>
        <field>X1st_Escalation_Approver_Completed__c</field>
        <literalValue>1</literalValue>
        <name>Set 1st Escalation Approver Completed</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Update_Corrective_Actions_Submitted</fullName>
        <description>Update the Corrective Actions Submitted Date to be todays date</description>
        <field>Corrective_Actions_Submitted_Date__c</field>
        <formula>Today()</formula>
        <name>Update Corrective Actions Submitted</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Update_Investigation_Activity_Status</fullName>
        <description>Update Investigation Activity Status to Open</description>
        <field>Activities_Status__c</field>
        <literalValue>Open</literalValue>
        <name>Update Investigation Activity Status</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        <fullName>Escalated and Approved Investigation Alert</fullName>
        <active>false</active>
        <criteriaItems>
        ...
        <criteriaItems>
            ...
            <operation>equals</operation>
            <value>Escalated Approved</value>
        </criteriaItems>
        <description>Notification to case owner upon approval of an Escalated Investigation</description>
    ...
    <rules>
        <fullName>Send notification to Licensor %2F Supervisor on closing</fullName>
        <actions>
            <name>Alert_Licensor_and_Supervisor_on_escalated_investigation_closing</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <description>When closing an escalated investigation, licensor and licensor supervisor should be notified by email #126. This is the implementation of story #4473</description>
        <formula>ISPICKVAL ( Investigation_Status__c , &quot;Closed&quot;)  &amp;&amp;  Escalated_Investigation__c = True  &amp;&amp;  NOT(ISBLANK(Closed_Date__c))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>ISCHANGED(Assigned_To__c) &amp;&amp; NOT(ISBLANK(PRIORVALUE(Assigned_To__c)))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
